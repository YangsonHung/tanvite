export const showcaseMessages = {
  en: {
    ...
    home: {
      ...
      heroBody:
        "TanVite is a focused front-end baseline for teams that want OpenSpec, .agents/skills for Codex, .claude/skills plus OPSX commands for Claude Code, React 19, TanStack Router, TanStack Query, OpenAPI tooling, Tailwind CSS, Biome, Vitest, and Playwright working together without carrying the usual starter clutter.",
...
pnpm dev`,
      ...
      workflow: {
        item1: {
          title: "Bootstrap",
          body: "Install dependencies, generate the route tree, and start the Vite dev server with one predictable path.",
        },
        item2: {
      ...
      commands: {
        item1: { label: "Install", command: "pnpm install" },
    ...
    guide: {
      ...
      overviewBody:
        "Use this page as the fast path into TanVite. It shows the starter positioning, .agents/skills for Codex, .claude/skills and OPSX commands for Claude Code, backend contract wiring, and the next entry points into the repository.",
      ...
      sections: {
        gettingStarted: {
          ...
          point1: "Install dependencies with pnpm install.",
          point2:
          ...
          point6: "Use pnpm build:pages when preparing the public showcase site.",
        },
        stack: {
  ...
  "zh-CN": {
    ...
    home: {
      ...
      heroBody:
        "TanVite 是一个聚焦型前端工程基线，适合希望把 OpenSpec、面向 Codex 的 .agents/skills、面向 Claude Code 的 .claude/skills 与 OPSX commands、React 19、TanStack Router、TanStack Query、OpenAPI 工具链、Tailwind CSS、Biome、Vitest 和 Playwright 一起用起来的团队。",
      primaryCta: "查看技术栈",
      guideCta: "阅读指南",
...
pnpm dev`,
      ...
      workflow: {
        item1: {
          title: "初始化",
          body: "安装依赖、生成路由树、启动 Vite 开发服务器，整个起步路径保持可预测。",
        },
        item2: {
          title: "规格到实现",
      ...
      commands: {
        item1: { label: "安装", command: "pnpm install" },
    ...
    guide: {
      ...
      overviewLabel: "概览",
      overviewBody:
        "这里可以快速看到 TanVite 的定位、面向 Codex 的 .agents/skills、面向 Claude Code 的 .claude/skills 与 OPSX commands、契约接入方式，以及继续深入仓库的入口。",
      commandsLabel: "命令",
      ...
      sections: {
        gettingStarted: {
          title: "快速上手",
          point1: "使用 pnpm install 安装依赖。",
          point2:
            "将 .env.example 复制为 .env.local，并把 OPENAPI_SCHEMA_URL 改成你的后端 Swagger/OpenAPI 地址。",
          point3: "先执行 pnpm openapi:check 校验契约，再运行 pnpm openapi:generate 生成客户端。",
          point4: "使用 pnpm dev 启动本地开发环境。",
          point5: "常规生产构建使用 pnpm build。",
          point6: "对外展示站构建使用 pnpm build:pages。",
        },
        stack: {
          title: "内置能力",
          point1: "React 19 + TypeScript + Vite 5",
          point2: "spec-driven 模式的 OpenSpec、面向 Codex 的 .agents/skills 与面向 Claude Code 的 .claude/skills",
          point3:

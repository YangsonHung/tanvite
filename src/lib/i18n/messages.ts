export const messages = {
  en: {
    ...
    starter: {
      ...
      body: 'This starter entry stays intentionally neutral. Routing, query client, OpenAPI tooling, OpenSpec workflow, testing, and shared runtime utilities remain in the starter app. The marketing landing page and guide now live under the separate showcase app.',
  ...
  'zh-CN': {
    ...
    starter: {
      ...
      body: '这个 starter 入口保持中性。路由、Query Client、OpenAPI 工具链、OpenSpec 工作流、测试能力和共享运行时工具仍然在主应用里，营销落地页和指南则被拆到独立的 showcase 应用中。',
